...
function isPageLoaded() {
   ...
   var checkIfPageLoaded = setInterval(function () {
       count++;
       spotIframe = document.querySelector("section[class='module below-the-post aol-comments']").querySelectorAll("iframe")[0];
       if (spotIframe != null) {
           clearInterval(checkIfPageLoaded);
           console.log("Page have loaded.");
           document.querySelector("section[class='module below-the-post aol-comments']").appendChild(commentContainer);
